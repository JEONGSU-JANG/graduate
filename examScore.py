...
if __name__=="__main__":
    version=10
    save="c:/users/Jeongsu Jang/Desktop/2018-1/paper/RBF+pageRank/correcting-success2/tcas/BestExamScore-outputWeight.txt"
    f=open(save, "w")
    while(version<38):
        rankfile="C:/users/Jeongsu Jang/Desktop/2018-1/paper/RBF+pageRank/correcting-success2/tcas/outputWeighted/Weight_v"+str(version)+".txt"
        ...
        f.write("\nBest Examscore version"+str(version)+": "+str(float((key+1)*100)/float(len(rank))))
        version=version+1
